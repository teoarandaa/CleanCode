...
// MARK: - Variables for data.json groups
struct DataSection: Codable, Identifiable {
    var id: UUID { UUID() }
    var name: String
    var items: [DataItem]
}

// MARK: - In data.json groups, variables for items in every group (ALL MUST BE THE SAME)
